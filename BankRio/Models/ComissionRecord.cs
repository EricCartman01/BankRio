...
namespace BankRio.Models
{
    public class ComissionRecord
    {
        ...
        public ComissionRecord(int id, DateTime date, StockBroker stockBroker, Advisor advisor, string certified, Yield yield, Product product, double value, double liquidValue, double percentualAdvisor, double profitAdvisor)
        {
            Id = id;
            Date = date;
        ...
        public void AddComission(ComissionRecord comission)
        {
